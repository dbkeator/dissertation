...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{media/chapter4/stacktrace/torsten-hidden.png}
\caption{The Conceptual Architecture of CueNet.}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{media/chapter4/stacktrace/calendar.png}
\caption{The Conceptual Architecture of CueNet.}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{media/chapter4/stacktrace/context-network-torsten.png}
\caption{The Conceptual Architecture of CueNet.}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{media/chapter4/stacktrace/sources.png}
\caption{The Conceptual Architecture of CueNet.}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{media/chapter4/stacktrace/time-space-selected.png}
\caption{The Conceptual Architecture of CueNet.}
\label{fig:stacktrace-simple-exif}
\end{figure}
