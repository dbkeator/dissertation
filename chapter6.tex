...
\section{Experiments}
We investigate the convergence behavior of our propagation algorithm, and evaluate the performance of the propagation algorithm on one of our datasets from chapter 5 in the absence of some context.

\begin{figure}[t]
\centering
\includegraphics[width=0.85\textwidth]{media/chapter6/convergences.png}
\caption{Varying values of decay factor.}
